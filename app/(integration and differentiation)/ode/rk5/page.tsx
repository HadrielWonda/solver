...
const CodeDialog = () => {
  ...
  return (
    ...
    >
      <DialogHeader>
        <DialogTitle>Fifth-Order Runge-Kutta: Butcher’s Method</DialogTitle>
        <DialogDescription>
          ...
          <div className="space-y-2">
            ...
            <div>
              ...
              <section>
                ...
                <Parargraph>
                  Where more accurate results are required, Butcher’s (1964) fi
                  fth-order RK method is recommended:
                </Parargraph>
                <MathBlock>
                  <MathRow>
                    <MathData>
                ...
                <Parargraph>
                  Higher-order RK formulas such as Butcher’s method are
                  available, but in general, beyond fourth-order methods the
                  gain in accuracy is offset by the added computational effort
                  and complexity.
                </Parargraph>
              </section>
            </div>
...
const SolveSection = ({ intro }: { intro: () => void }) => {
  ...
  const {
    ...
    async () => {
      try {
        const res = await fetch("http://127.0.0.1:8000/ode/rk5", {
          method: "POST",
          headers: {
              ...
              <TableBody className="h-100% overflow-auto">
                {results.map((r) => (
                  <TableRow key={r.iteration}>
                    ...
                    <TableCell>{r.k5}</TableCell>
                    <TableCell>{r.k6}</TableCell>
                  </TableRow>
                ))}
              </TableBody>
            </Table>
