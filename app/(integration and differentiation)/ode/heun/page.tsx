...
const CodeDialog = () => {
  ...
  return (
    ...
    >
      <DialogHeader>
        <DialogTitle>Heun’s Method</DialogTitle>
        <DialogDescription>
        ...
        <div className="container flex flex-col items-center justify-center max-w-5xl px-4 space-y-4 md:space-y-8 md:px-6">
            ...
            <div className="p-3 bg-white border-2 border-borderColor rounded-xl z-10">
              <Breadcrumb>
                <BreadcrumbList>
                  ...
                  <BreadcrumbSeparator />
                  <BreadcrumbItem>
                    <BreadcrumbPage>Heun’s Method</BreadcrumbPage>
                  </BreadcrumbItem>
                </BreadcrumbList>
              </Breadcrumb>
            </div>
          ...
          <div className="space-y-2">
            ...
            <div>
              <ODESection />
              <section>
                <h4 className="bold font-bold my-2 text-left">Heun’s Method</h4>

                <Parargraph>
                  One method to improve the estimate of the slope in Euler's
                  Method involves the determination of two derivatives for the
                  interval—one at the initial point and another at the end
                  point. The two derivatives are then averaged to obtain an
                  improved estimate of the slope for the entire interval. This
                  approach is called Heun’s method.
                </Parargraph>
                <MathBlock>
                  <MathRow>
                    <MathData>
                ...
                <Parargraph>
                  This is called a <strong>predictor equation</strong>. It
                  ...
                  that allows the calculation of an estimated slope at the end
                  of the interval
                </Parargraph>
                <MathBlock>
                  <MathRow>
                ...
                <Parargraph>
                  Thus, the two slopes can be combined to obtain an average
                ...
                <Parargraph>
                  which is called a <strong>corrector equation</strong>
                </Parargraph>
              </section>
            </div>
            <div>
...
const SolveSection = ({ intro }: { intro: () => void }) => {
  ...
  const {
    ...
    async () => {
      try {
        const res = await fetch("http://127.0.0.1:8000/ode/heun", {
          method: "POST",
          headers: {
              ...
              <TableBody className="h-100% overflow-auto">
                {results.map((r) => (
                  <TableRow key={r.iteration}>
                    ...
                    <TableCell>{r.yi}</TableCell>
                    <TableCell>{r.yi1}</TableCell>
