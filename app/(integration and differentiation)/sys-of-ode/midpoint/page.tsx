...
const CodeDialog = () => {
  ...
  return (
    ...
    >
      <DialogHeader>
        <DialogTitle>The Midpoint (or Improved Polygon) Method</DialogTitle>
        <DialogDescription>
          ...
          <div className="space-y-2">
            ...
            <div>
              ...
              <section>
                ...
                <Parargraph>
                  This technique is a simple modification of Euler's method that
                  uses Euler’s method to predict a value of y at the midpoint of
                  the interval
                </Parargraph>
                <MathBlock>
                  <MathRow>
                ...
                <Parargraph>
                  which is assumed to represent a valid approximation of the
                  average slope for the entire interval. This slope is then used
                  to extrapolate linearly from{" "}
                  <math>
                    <msub>
                      <mi>x</mi>
                      <mi>i</mi>
...
const SolveSection = ({ intro }: { intro: () => void }) => {
  ...
  const {
    ...
    async () => {
      try {
        const res = await fetch("http://127.0.0.1:8000/sys-of-ode/midpoint", {
          method: "POST",
          headers: {
