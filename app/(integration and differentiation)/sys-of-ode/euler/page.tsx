...
const CodeDialog = () => {
  ...
  return (
    ...
    >
      <DialogHeader>
        <DialogTitle>Euler’s Method</DialogTitle>
        <DialogDescription>
            ...
            <div className="p-3 bg-white border-2 border-borderColor rounded-xl z-10">
              <Breadcrumb>
                <BreadcrumbList>
                  ...
                  <BreadcrumbSeparator />
                  <BreadcrumbItem>
                    <BreadcrumbPage>Euler’s Method</BreadcrumbPage>
                  </BreadcrumbItem>
                </BreadcrumbList>
              </Breadcrumb>
            </div>
          ...
          <div className="space-y-2">
            ...
            <div>
              ...
              <section>
                ...
                <Parargraph>
                  The first derivative provides a direct estimate of the slope
                  at xi
                </Parargraph>
                <MathBlock>
                  <MathRow>
                ...
                <Parargraph>
                  ...
                  . This estimate can be substituted in the general equation to
                  give:
                </Parargraph>
                <MathBlock>
                  <MathRow>
                ...
                <Parargraph>
                  ...
                  <strong>
                    Euler’s (or the Euler-Cauchy or the point-slope) method
                  </strong>
                  . A new value of y is predicted using the slope (equal to the
                  fi rst derivative at the original value of x) to extrapolate
...
const SolveSection = ({ intro }: { intro: () => void }) => {
  ...
  const {
    ...
    async () => {
      try {
        const res = await fetch("http://127.0.0.1:8000/sys-of-ode/euler", {
          method: "POST",
          headers: {
