...
}: // solve,
{
  open: boolean;
  close: () => void;
  setInitialSettings: (settings: boundarySettings) => void;
  // solve: any;
  running: boolean;
}) => {
  ...
  const valid =
    !isNaN(Number(settings.x_0)) &&
    !isNaN(Number(settings.x_L)) &&
    !isNaN(Number(settings.y_0)) &&
    !isNaN(Number(settings.y_L)) &&
