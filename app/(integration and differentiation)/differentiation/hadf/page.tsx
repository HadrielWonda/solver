...
const CodeDialog = () => {
  ...
  return (
    ...
    >
      <DialogHeader>
        <DialogTitle>High-Accuracy Differentiation Formulas</DialogTitle>
        <DialogDescription>
          ...
          <div className="space-y-2">
            ...
            <div>
              ...
              <section>
                ...
                <Parargraph>
                  We now retain the second-derivative term by substituting the
...
const SolveSection = ({ intro }: { intro: () => void }) => {
  ...
  const {
    ...
    async () => {
      try {
        const res = await fetch("http://127.0.0.1:8000/differentiation/hadf", {
          method: "POST",
          headers: {
