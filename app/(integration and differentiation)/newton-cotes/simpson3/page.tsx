...
const CodeDialog = () => {
  ...
  return (
    ...
    >
      <DialogHeader>
        <DialogTitle>The Simpson’s 3/8 Rule</DialogTitle>
        <DialogDescription>
            ...
            <div className="p-3 bg-white border-2 border-borderColor rounded-xl z-10">
              <Breadcrumb>
                <BreadcrumbList>
                  ...
                  <BreadcrumbSeparator />
                  <BreadcrumbItem>
                    <BreadcrumbPage>The Simpson’s 3/8 Rule</BreadcrumbPage>
                  </BreadcrumbItem>
                </BreadcrumbList>
              </Breadcrumb>
            </div>
          ...
          <div className="space-y-2">
            ...
            <div>
              ...
              <section>
                ...
                />
                <Parargraph>
                  Simpson’s 3/8 rule results a thirdorder Lagrange polynomial
                  can be fi t to four points and integrated:
                </Parargraph>
                <MathBlock>
                  <MathRow>
                    <MathData>
                ...
                <Parargraph>
                  This equation is known as Simpson’s 3/8 rule.
                </Parargraph>
              </section>
            </div>
            <div>
...
const SolveSection = ({ intro }: { intro: () => void }) => {
  ...
  const {
    ...
    async () => {
      try {
        const res = await fetch("http://127.0.0.1:8000/newton-cotes/simpson3", {
          method: "POST",
          headers: {
