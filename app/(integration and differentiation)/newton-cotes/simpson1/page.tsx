...
const CodeDialog = () => {
  ...
  return (
    ...
    >
      <DialogHeader>
        <DialogTitle>The Simpson’s 1/3 Rule</DialogTitle>
        <DialogDescription>
            ...
            <div className="p-3 bg-white border-2 border-borderColor rounded-xl z-10">
              <Breadcrumb>
                <BreadcrumbList>
                  ...
                  <BreadcrumbSeparator />
                  <BreadcrumbItem>
                    <BreadcrumbPage>The Simpson’s 1/3 Rule</BreadcrumbPage>
                  </BreadcrumbItem>
                </BreadcrumbList>
              </Breadcrumb>
            </div>
            ...
            <div>
              ...
              <section>
                ...
                <Parargraph>
                  ...
                  polynomial is substituted for f(x)
                </Parargraph>
                <MathBlock>
                  <MathRow>
                    <MathData>
                ...
                <Parargraph>
                  ...
                  and f(x) is represented by a second-order Lagrange polynomial,
                ...
                <Parargraph className="mt-4">
                  The Multiple-Application Simpson’s 1/3 Rule can be derived to
                  be:
                </Parargraph>
                <MathBlock>
                  <MathRow>
...
const SolveSection = ({ intro }: { intro: () => void }) => {
  ...
  const {
    ...
    async () => {
      try {
        const res = await fetch("http://127.0.0.1:8000/newton-cotes/simpson1", {
          method: "POST",
          headers: {
