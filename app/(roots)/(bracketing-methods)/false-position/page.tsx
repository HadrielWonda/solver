...
const CodeDialog = () => {
  ...
  return (
    ...
    >
      <DialogHeader>
        <DialogTitle>False-Position Algorithm</DialogTitle>
        <DialogDescription>
            ...
            <div className="p-3 bg-white border-2 border-borderColor rounded-xl z-10">
              <Breadcrumb>
                <BreadcrumbList>
                  ...
                  <BreadcrumbSeparator />
                  <BreadcrumbItem>
                    <BreadcrumbPage>False-Position Method</BreadcrumbPage>
                  </BreadcrumbItem>
                </BreadcrumbList>
              </Breadcrumb>
            </div>
          ...
          <div className="space-y-2">
            ...
            <section>
              <Parargraph>
                ...
                interval from xl to xu into equal halves, no account is taken of
                the magnitudes of f(xl) and f(xu). For example, if f(xl) is much
                closer to zero than f(xu), it is likely that the root is closer
                to xl than to xu.
              </Parargraph>
              <Parargraph>
                An alternative method that exploits this graphical insight is to
                join f(xl) and f(xu) by a straight line. The intersection of
                this line with the x axis represents an improved estimate of the
                ...
                name, method of false position, or in Latin, regula falsi. It is
                also called the linear interpolation method. Using similar
                triangles (Fig. 5.12), the intersection of the straight line
              ...
              <Parargraph>
                This is the false-position formula. The value of xr computed
                then replaces whichever of the two initial guesses, xl or xu,
                yields a function value with the same sign as f(xr). In this
                way, the values of xl and xu always bracket the true root. The
                process is repeated until the root is estimated adequately.
              </Parargraph>
            </section>
            <div>
...
const FalsePositionSolve = () => {
  ...
  const {
    ...
    "/api/user",
    async () => {
      const res = await fetch("/false-position/api", {
        method: "post",
