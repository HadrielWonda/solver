...
export const Sidebar = ({
  ...
  const id = useId();
  const [settings, setSettings] = useState<BrentMethodSettings>({
    equation: "",
    latex: "",
    xi: "",
    xj: "",
  ...
  const valid =
    !isNaN(Number(settings.xi)) &&
    !isNaN(Number(settings.xj)) &&
    !isNaN(Number(settings.xk)) &&
      ...
      {open && (
        ...
        >
          ...
          <div className=" flex-1 w-full overflow-auto p-3">
            <h3 className="font-semibold mb-4">Brent’s Method</h3>
