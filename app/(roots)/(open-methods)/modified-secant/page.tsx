...
const CodeDialog = () => {
  ...
  return (
    ...
    >
      <DialogHeader>
        <DialogTitle>Modified Secant Method</DialogTitle>
        <DialogDescription>
        ...
        <div className="container flex flex-col items-center justify-center max-w-5xl px-4 space-y-4 md:space-y-8 md:px-6">
            ...
            <div className="p-3 bg-white border-2 border-borderColor rounded-xl z-10">
              <Breadcrumb>
                <BreadcrumbList>
                  ...
                  <BreadcrumbSeparator />
                  <BreadcrumbItem>
                    <BreadcrumbPage>Modified Secant Method</BreadcrumbPage>
                  </BreadcrumbItem>
                </BreadcrumbList>
              </Breadcrumb>
            </div>
          ...
          <div className="space-y-2">
            ...
            <section>
              ...
              <Parargraph>
                where ẟ = a small perturbation fraction. This approximation can
                be substituted into the Secant Equation to yield the following
                iterative equation:
              </Parargraph>
              <MathBlock>
                <MathRow>
...
const SolveSection = ({ intro }: { intro: () => void }) => {
  ...
  const {
    ...
    async () => {
      ...
      const res = await fetch("/modified-secant/api", {
        method: "post",
