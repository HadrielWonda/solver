...
const CodeDialog = () => {
  ...
  return (
    ...
    >
      <DialogHeader>
        <DialogTitle>Secant Method</DialogTitle>
        <DialogDescription>
            ...
            <div className="p-3 bg-white border-2 border-borderColor rounded-xl z-10">
              <Breadcrumb>
                <BreadcrumbList>
                  ...
                  <BreadcrumbSeparator />
                  <BreadcrumbItem>
                    <BreadcrumbPage>Secant Method</BreadcrumbPage>
                  </BreadcrumbItem>
                </BreadcrumbList>
              </Breadcrumb>
            </div>
          ...
          <div className="space-y-2">
            ...
            <section>
              <Parargraph className="mb-4">
                ...
                the evaluation of the derivative. Although this is not
                inconvenient for polynomials and many other functions, there are
                certain functions whose derivatives may be extremely diffi cult
                or inconvenient to evaluate. For these cases, the derivative can
                be approximated by a backward fi nite divided difference.
              </Parargraph>
              <Parargraph>
                The Secant method can be derived on the basis of this
                geometrical interpretation. The first derivative at x is
              ...
              <Parargraph>
                ...
                Equation to yield the following iterative equation:
              </Parargraph>
              <MathBlock>
                <MathRow>
                  <MathData>
              ...
              <Parargraph>which is called the Secant formula.</Parargraph>
            </section>
            <div>
...
const SolveSection = ({ intro }: { intro: () => void }) => {
  ...
  const {
    ...
    async () => {
      ...
      const res = await fetch("/secant/api", {
        method: "post",
