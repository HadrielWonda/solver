...
export const Sidebar = ({
  ...
  const id = useId();
  const [settings, setSettings] = useState<SecantIterationSettings>({
    equation: "",
    latex: "",
    x0: "",
    x1: "",
      ...
      {open && (
        ...
        >
          ...
          <div className=" flex-1 w-full overflow-auto p-3">
            <h3 className="font-semibold mb-4">Secant Method</h3>
