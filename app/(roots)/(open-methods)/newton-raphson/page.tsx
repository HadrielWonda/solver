          ...
          <div className="space-y-2">
            ...
            <section>
              <Parargraph className="mb-4">
                Perhaps the most widely used of all root-locating formulas is
                the Newton-Raphson equation. If the initial guess at the root is
                xi, a tangent can be extended from the point [xi, f(xi)]. The
                point where this tangent crosses the x axis usually represents
              ...
              <Parargraph>which can be rearranged to yield</Parargraph>
              <MathBlock>
                <MathRow>
                  <MathData>
                    <msub>
...
const SolveSection = ({ intro }: { intro: () => void }) => {
  ...
  const {
    ...
    async () => {
      ...
      const res = await fetch("/newton-raphson/api", {
        method: "post",
